...
export default function LHN({ appState, onNavigate, onPreviousQuestion, canGoPrevious }: LHNProps) {
  ...
  return (
    <>
      {/* Mobile Menu Button */}
      <button 
        className="fixed top-4 right-4 z-50 md:hidden bg-black/90 p-2 rounded-full"
      ...
      <motion.div
        className="fixed top-0 left-0 w-full bg-black/90 md:hidden z-40"
        initial={{ y: -100 }}
      ...
      <div className="hidden md:block fixed left-0 top-0 h-full w-16 bg-black/90">
